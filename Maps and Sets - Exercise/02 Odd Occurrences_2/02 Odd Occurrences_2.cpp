// 02 Odd Occurrences_2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	std::map<std::string, int> words = std::map<std::string, int>();
