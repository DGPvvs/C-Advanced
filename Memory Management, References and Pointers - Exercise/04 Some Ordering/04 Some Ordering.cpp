// 04 Some Ordering.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	output.append(input.ToLower()).append(myString().NewLine()).append(input.ToUpper());
...
//Write a program that receives a string with N elements and returns two other strings – the first one is the same string with lower-case letters only,
//and the second one is the same string with upper-case letters only. Write the program with the help of pointers!
