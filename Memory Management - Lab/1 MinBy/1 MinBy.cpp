// 1 MinBy.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	if (taskNum == 1)
	{
		std::set<std::string> set = std::set<std::string>(list.begin(), list.end());
		output.append(*set.begin()).append(myString().NewLine());
	}
	else if (taskNum == 2)
	{
		std::set<std::string, classcompless> set = std::set<std::string, classcompless>(list.begin(), list.end());
		output.append(*set.begin()).append(myString().NewLine());
	}
	else
	{
		std::set<std::string, classcompgreater> set = std::set<std::string, classcompgreater>(list.begin(), list.end());
		output.append(*set.begin()).append(myString().NewLine());
	}
